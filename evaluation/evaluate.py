...
# Table Setup
table = PrettyTable()
table.field_names = ["Question", "Generated Answer", "Perplexity", "BERTScore Precision", "BERTScore Recall", "BERTScore F1"]
...
for item in random_qa_pairs:
    ...
    # Add row to table
    table.add_row([question, generated_answer, perplexity, round(P[0].item(), 3), round(R[0].item(), 3), round(F1[0].item(), 3)])
...
with open("eval_table_with_bert_score.txt", "w") as f:
